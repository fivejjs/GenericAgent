...
class BaseHandler:
    ...
    def tool_after_callback(self, tool_name: str, args: dict, response: Any, ret: Any):
        pass

    def turn_end_callback(
        self, response: Any, tool_calls: list, tool_results: list, turn: int, next_prompt: str, exit_reason: dict
    ) -> str:
        return next_prompt
